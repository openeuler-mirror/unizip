...
void zip7_init(callback_t *cb_7zip) {
  cb_7zip->versionCB = versionCB_7zip;
  cb_7zip->deflateCB = deflateCB_7zip;
  cb_7zip->deflateInitCB = deflateInitCB_7zip;
  cb_7zip->deflateEndCB = deflateEndCB_7zip;
  cb_7zip->inflateInitCB = inflateInitCB_7zip;
  cb_7zip->inflateCB = inflateCB_7zip;
  cb_7zip->inflateEndCB = inflateEndCB_7zip;
  cb_7zip->deflateCopyCB = deflateCopyCB_7zip;
  cb_7zip->inflateCopyCB = inflateCopyCB_7zip;
  cb_7zip->deflateResetCB = deflateResetCB_7zip;
  cb_7zip->inflateResetCB = inflateResetCB_7zip;
  cb_7zip->compressCB = compressCB_7zip;
  cb_7zip->uncompressCB = uncompressCB_7zip;
  cb_7zip->compressBoundCB = compressBound_7zip;
}
